...
public class softwareDownload extends javax.swing.JFrame {
    ...
    public softwareDownload() {
        ...
        System.out.print( ANSI_YELLOW + "[ INFO ] "+ANSI_RESET+" Iniciando Cliente Multicast. ");
        System.out.print( ANSI_YELLOW + "[ INFO ] "+ANSI_RESET+" Iniciando Cliente Multicast CL. ");
        System.out.print( ANSI_YELLOW + "[ INFO ] "+ANSI_RESET+" Iniciando Cliente RMI. ");
        System.out.println( ANSI_YELLOW + "[ INFO ] "+ANSI_RESET+" Iniciando Cliente Unicast. ");
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, 30, 30));
        getContentPane().add(inputFileName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 260, 60));
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 30, 110, 60));
        getContentPane().add(progressBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 600, 10));

        lblResult.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        lblResult.setForeground(new java.awt.Color(102, 255, 102));
        lblResult.setText("FOUND!");
        getContentPane().add(lblResult, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 40, 100, 40));
        ...
        getContentPane().add(btnDownload, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 250, 60));

        lblWallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo.png"))); // NOI18N
        lblWallpaper.setText("jLabel1");
        getContentPane().add(lblWallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 270));
