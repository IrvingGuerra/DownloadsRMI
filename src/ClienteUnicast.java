...
public class ClienteUnicast extends Thread{
    ...
    String local = "/Users/irvingguerra/Documents/softDownloadClient/src/descargas";
    ...
    public ClienteUnicast(database db, softwareDownload frameSoftware){
        ...
        this.db = db;
        System.out.print( ANSI_BLUE + "[ CREATED ] "+ANSI_RESET+" Cliente Unicast Creado. ");
    }
    
    public void run(){
        System.out.println( ANSI_GREEN + "[ INIT ] "+ANSI_RESET+" Cliente Unicast Iniciado");
    }
